...
namespace Apollo.Devices {
    public class Tone: Device {
        ...
        public class SatHighUndoEntry: SimplePathUndoEntry<Tone, double> {
            ...
            SatHighUndoEntry(BinaryReader reader, int version): base(reader, version){}
        }
        ...
        public class SatLowUndoEntry: SimplePathUndoEntry<Tone, double> {
            ...
            SatLowUndoEntry(BinaryReader reader, int version): base(reader, version){}
        }
        ...
        public class ValueHighUndoEntry: SimplePathUndoEntry<Tone, double> {
            ...
            ValueHighUndoEntry(BinaryReader reader, int version): base(reader, version){}
        }
        ...
        public class ValueLowUndoEntry: SimplePathUndoEntry<Tone, double> {
            ...
            ValueLowUndoEntry(BinaryReader reader, int version): base(reader, version){}
        }
    }
}