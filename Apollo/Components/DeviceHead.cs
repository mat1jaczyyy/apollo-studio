...
namespace Apollo.Components {
    public class DeviceHead: UserControl {
        ...
        void HandleUnloaded(object sender, VisualTreeAttachmentEventArgs e) => Owner = null;

        public void SetEnabled(bool value) {
            Border.Background = (IBrush)Apollo.Core.App.FindResource(value? "ThemeControlHighBrush" : "ThemeControlMidBrush");
            Border.BorderBrush = (IBrush)Apollo.Core.App.FindResource(value? "ThemeBorderMidBrush" : "ThemeBorderLowBrush");
        }
